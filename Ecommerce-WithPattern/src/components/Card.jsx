const ProductCard = ({ title, description, price, discountPercentage,category, thumbnail}) => {
    return (
      <div className=" bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 group">
        ...
        <div className="relative overflow-hidden h-64">
          <img
            src={thumbnail}
            alt={title}
            className="w-full h-full position-center group-hover:scale-110 transition duration-500"
          />
        ...
        <div className="p-5">
          ...
          {/* Button */}
          <button className="w-full py-3 bg-pink-500 text-white rounded-xl font-semibold text-lg hover:bg-pink-600 transition duration-300">
            Add To Cart
          </button>
        </div>
      </div>
